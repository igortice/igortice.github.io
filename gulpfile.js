// Generated on 2015-05-24 using generator-jekyllized 0.7.3
"use strict";
...
gulp.task("symlink:dev", function (){
  ...
  gulp
    .src([
      'src/_bower_components/foundation/css/normalize.css',
      'src/_bower_components/foundation/css/foundation.css',
      'src/_bower_components/font-awesome/css/font-awesome.css',
      'src/_bower_components/animsition/dist/css/animsition.css'
    ])
    .pipe(symlink(function (source){
      return p.resolve('src/assets/stylesheets', p.basename(source.path))
    }, { force: true }));

  // Link FONTS
  gulp
    .src([
      'src/_bower_components/font-awesome/fonts/*'
    ])
    .pipe(symlink(function (source){
      return p.resolve('src/assets/fonts', p.basename(source.path))
    }, { force: true }));
  ...
  gulp
    .src([
      ...
      'src/_bower_components/foundation/js/foundation.js',
      'src/_bower_components/angular/angular.js',
      'src/_bower_components/angular-gravatar/build/angular-gravatar.js',
      'src/_bower_components/animsition/dist/js/jquery.animsition.js'
    ])
    .pipe(symlink(function (source){
      return p.resolve('src/assets/javascript', p.basename(source.path))
    }, { force: true }));
});
